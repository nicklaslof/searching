...
class Player extends Entity{
    ...
    tick(deltaTime, level){
        ...
        if (inputHandler.isKeyDown(65))LevelRender.camera.rotate(6 * deltaTime);
        if (inputHandler.isKeyDown(68))LevelRender.camera.rotate(-6 * deltaTime);
        if (inputHandler.isKeyDown(87))v.z = -6;
        if (inputHandler.isKeyDown(83))v.z = 6;
